...
<html>
    ...
    <body>
        ...
        ?>
        <!-- https://www.youtube.com/watch?v=GMIn4Hk7tlY video 1
         https://www.youtube.com/watch?v=Umrazq1V9NA video 2-->
        ...
        <div class="container">
            <div class="row aling-items-center mt-5" >
                <div class="col" id="noticias">
                    ...
                    <br>
                    <br>
                    <img class="w-80" id="noticiaimg"src="https://www.floresyplantas.net/wp-content/uploads/campos-de-lavanda-de-brihuega-2-696x466.jpg" alt="foto articulo"><p><a href="https://www.floresyplantas.net/campos-de-lavanda-de-brihuega/">Campos de lavanda de Brihuega</a></p>
                </div>
            </div>
            <div class="embed-responsive embed-responsive-16by9">
                <iframe class="embed-responsive-item" src="//www.youtube.com/watch?v=GMIn4Hk7tlY"></iframe>
            </div>
             <div class="embed-responsive embed-responsive-16by9">
                <iframe class="embed-responsive-item" src="//www.youtube.com/watch?v=Umrazq1V9NA"></iframe>
            </div>
        </div>
